...
//
// Contents:
//   This file contains the defition of the Font object.
//   The Font object is used by the HudObject to write
//   text on the screen. The Font object contains
//   information about the size and spacing of characters
//   for a font. The symbols are stored in a single .dmi
//   file, where each icon state's name is the symbol.
//   The library comes with a sample font, look in
//   text-demo\demo.dm to see how it is used.
//
//   The Font object contains these procs:
//
//     * char_width()
//     * word_width()
//     * cut_word()
...
//     * wrap_text()
//
//   The Font object contains these vars:
//
//     * icon
//     * char_width
//     * descent
...
//     * line_height
//
//   This file contains descriptions of these vars and
//   procs.
	...
	proc
		...
		wrap_text(txt, line_width)
			...
			for(var/i = 1 to words.len)
				...
				// if we hit a linebreak that was already in the string, add
				// it to the output and return to the beginning of the line.
				if(words[i] == "\n")
					output += "\n"
					px = 0
					continue
