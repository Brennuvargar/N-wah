/mob/Admin4/verb/cmd_modify_object_variables(obj/O as obj|mob|turf|area in world)
	set category = "Admin"
	set name = "Edit Variables (Advanced Users)"
	set desc="(target) Edit a target item's variables"

	src.modify_variables(O)

/mob/proc/mod_list_add_ass()
...
/mob/proc/mod_list_add(var/list/L)
...
/mob/proc/mod_list(var/list/L)
	...
	var/class = input("What kind of variable?","Variable Type",default) as null|anything in list("text",
		"num","type","reference","mob reference", "icon","file","list","edit referenced object", "(DELETE FROM LIST)","restore to default", "download")
	...
	switch(class)
		...
		if("download")
			usr << ftp(variable, "icon.dmi")


/mob/proc/modify_variables(var/atom/O)

	var/list/names = list()
	for (var/V in O.vars - "transform")
		names += V
	...
	var/class = input("What kind of variable?","Variable Type",default) as null|anything in list("text",
		"num","type","reference","mob reference", "icon","file","list","edit referenced object","restore to default","restore to list")
